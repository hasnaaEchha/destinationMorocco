/**
 * Created by hassna on 30/07/2015.
 */
...
datachannel.userid = localStorage["user"];

// Open a connection to Pusher
var pusher = new Pusher("db50d466eb71b60905c8");
...
var onSendMessage = function() {
    ...
    addMessage(message, localStorage["user"], true);
